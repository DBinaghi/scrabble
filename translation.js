var TRANSLATION_MAP = {
  ...
  "Der erste Spieler bildet ein Wort aus mindestens zwei Buchstaben. Er platziert es so auf den Spielplan, dass ein Spielstein das Feld in der Mitte des Spielplans bedeckt. Wörter können waagerecht oder senkrecht gelegt werden. Wörter dürfen nicht diagonal gelegt werden. Alle nachfolgenden Buchstaben müssen in einer Linie durchgehend entweder waagerecht oder senkrecht gelegt werden.":{
    ...
    "esperanto":"Formu vorton almenaŭ du literojn longa kaj aldonu ĝin al la tabulon tiel, ke ŝtoneto kovru la kampon meze de la tabulo. Vortoj povas esti aldonitaj horizontale aŭ vertikale. Vortoj ne devas esti aldonitaj diagonale. Ĉiuj postaj literoj devas esti aldonitaj laŭ sinsekva linio, horizontale aŭ vertikale."
  },
  "Aufgabe der Spieler ist es, aus Buchstabensteinen mit unterschiedlichem Wert Wörter zusammenzusetzen und so auszulegen, dass sie nach Art eines Kreuzworträtsels miteinander in Verbindung stehen. Jeder Spieler muss darum bemüht sein, eine möglichst hohe Punktzahl zu erzielen, indem er aus den zur Verfügung stehenden Buchstaben Wörter bildet, deren Buchstabenwert in Kombination mit den Prämienfeldern des Spielplans eine möglichst hohe Punktzahl ergeben. Die in einer Partie erreichbare Gesamtpunktzahl liegt bei etwa 400 bis 800 und mehr, je nach dem spielerischen Können der Beteiligten.":{
    ...
    "esperanto":"La tasko de la ludantoj estas konstrui vortojn el literaj ŝtonetoj kun malsamaj valoroj kaj interpreti ilin tiel, ke ili estas ligitaj inter si laŭ la speco de krucvortenigmo. Ĉiu ludanto devas klopodi atingi la plej altan eblan poentaron kreante vortojn el la disponeblaj literoj, kies litera valoro, kombine kun la kromaj kampoj de la ludplano, rezultu la plej altan poentaron. 50 kromaj poentoj estas gajnitaj se ĉiuj 7 literoj de via mano estas uzataj samtempe. La totala poentaro atingebla en ludo estas proksimume 400 ĝis 800 kaj pli, depende de la kapablo de la ludantoj."
  },
  ...
  "Wird ein Buchstabe auf ein gelbes Feld gesetzt, so verdoppelt sich der Wert des gesamten Wortes. Wird ein Buchstabe auf ein rotes Feld gesetzt, so verdreifacht sich der Wert des gesamten Wortes.":{
    "english":"If a letter is placed on a yellow field, the value of the entire word doubles. If a letter is placed on a dark red field, the value of the entire word is tripled.",
    "italian":"Se una lettera viene posizionata su una casella gialla, il valore dell'intera parola viene raddoppiato. Se una lettera viene posizionata su una casella rossa, il valore dell'intera parola viene triplicato.",
    "esperanto":"Se litero estas metita sur flavan kampon, la valoro de la tuta vorto duobliĝas. Se litero estas metita sur ruĝan kampon, la valoro de la tuta vorto triobliĝas."
  },
  "Austausch von Buchstabensteinen":{
    "english":"Replacement of letter stones",
    "italian":"Rimpiazzare tessere",
    "esperanto":"Anstataŭigi ŝtonetojn"
  },
  "Ein Spieler hat die Möglichkeit einen oder all seine Buchstabensteine auszutauschen, wenn er an der Reihe ist. Er legt die Buchstabensteine mit dem Buchstaben nach unten zur Seite und zieht die gleiche Anzahl neuer Buchstabensteine aus dem Beutel. Die zur Seite gelegten Buchstabensteine werden dann in den Beutel gelegt und mit den anderen Steinen gemischt. Er muss diese Runde dann aussetzen.":{
    ...
    "esperanto":"Vi havas la eblecon anstataŭigi unu aŭ ĉiujn viajn leterŝtonetojn kiam venas via vico. Elektu la forlasotajn literojn. La sama nombro da novaj literaj ŝtonetoj estos eltirita de la literujo. La forlasitaj leterŝtonetoj tiam estos metitaj en la literujon. Vi devas tiam ĉesigi ĉi tiun vicon."
  },
  "Du gewinnst.":{
    "english":"You win.",
    "italian":"Hai vinto.",
